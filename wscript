...
from wscripts import crystalcandy

import os.path

APPNAME = 'crystalcandy'
VERSION = '0.1.0'
...
def _configureImpls( _context ):
    _configureMainImpl( _context )

def _configureMainImpl( _context ):
    MAIN_IMPL = _context.options.mainimpl
    ...
    _context.env.MY_MAIN_IMPL = MAIN_IMPL

def build( _context ):
    crystalcandy.build( _context )
